...
async function runLoadScenarios() {
  console.log(`\n========================================================`);
  console.log(`  GPMS 2.0 MULTI-USER LOAD TEST (BASELINE BENCHMARK)`);
  console.log(`========================================================\n`);
  ...
  // The mixed realistic workload requests task listing (which scans 5000 tasks on each hit)
  ...
  console.log("\n========================================================");
  console.log("             LOAD TEST SUMMARY (BASELINE)");
  console.log("========================================================");
  console.table(
    results.map((r) => ({
  ...
  const outputPath = path.resolve(__dirname, "load-test-results.json");
